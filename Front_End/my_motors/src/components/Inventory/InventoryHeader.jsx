...
export const InventoryHeader = () => {
  ...
  const calculateInterest = () => {
    ...
    const totalInterest =
      monthlyPayment * parseFloat(loanTerm) - parseFloat(vehiclePrice);
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8001/get-getproductHomeData/${id}`)
      .then((res) => {
  ...
  const onClickCompare = (e) => {
    compareNavigate(`/singlePage/compare`);
    e.preventDefault();
    const add = {
    ...
    // console.log(add);
    axios
      .post("http://localhost:8001/add-addToCompare", add)
      .then((response) => {
  ...
  const onClickCart = (e) => {
    ...
    // console.log(add);
    axios
      .post("http://localhost:8001/add-to-cart", add)
      .then((response) => {
        const userData = response.data.data;
        // console.log(userData);
      })
                ...
                {homePro.images && homePro.images.length > 0 && (
                  <>
                    <img
                      ...
                      alt={homePro.label}
                      className="h-full w-full position hov_1"
                    />
                    <div className=" h-auto w-auto absolute transition-all bottom-7 hover:scale-90 ps-3">
              ...
              <div className="h-auto">
                <Col className="">
                  <div className="text-white text-start h-auto p-2">
                    ...
                    <p>
                      ...
                      gravida sapien. Fusce eleifend vulputate nibh, non cursus
                      augue placerat pellentesque. Sed venenatis risus nec felis
                      mollis, in pharetra urna euismod. Morbi aliquam ut turpis
                      sit amet ultrices. Vestibulum mattis blandit nisl, et
                      tristique elit scelerisque nec. Fusce eleifend laoreet dui
                      eget aliquet. Ut rutrum risus et nunc pretium scelerisque.
                      Fusce viverra, ligula quis pellentesque interdum, leo
                      felis congue dui, ac accumsan sem nulla id lorem. Praesent
                      ut tristique dui, nec condimentum lacus. Maecenas lobortis
                      ante id egestas placerat. Nullam at ultricies lacus. Nam
                      in nulla consectetur, suscipit mauris eu, fringilla augue.
                      Phasellus gravida, dui quis dignissim tempus, tortor orci
                      tristique leo, ut congue diam ipsum at massa. Pellentesque
                    ...
                    <p>
                      ...
                      ultricies lacus. Nam in nulla consectetur, suscipit mauris
                      eu, fringilla augue. Phasellus gravida, dui quis dignissim
                      tempus, tortor orci tristique leo, ut congue diam ipsum at
                      massa. Pellentesque ut vestibulum erat. Donec a felis eget
                      tellus laoreet ultrices.
                    </p>
                  </div>
                </Col>
                {/* Engine */}
                <Row className="justify-center h-auto gap-5">
                  <Col className=" text-white" lg={5}>
                    <p className="flex font-semibold text-md gap-2 items-center">
                      {" "}
                      <TbEngine
                        size={35}
                    ...
                    <div className="border-b-2 border-gray-600 flex items-center p-2  justify-between">
                      <p className="text-wrap text-gray-500 font-semibold text-xs ">
                        {" "}
                    ...
                    <div className="border-b-2 border-gray-600 flex items-center p-2 justify-between">
                      ...
                      <p>
                        {" "}
                        {homePro.displacement} {homePro.engineVol}{" "}
                      </p>
                    </div>
                    <div className="border-b-2 border-gray-600 flex items-center p-2 justify-between">
                      <p className="text-wrap text-gray-500 font-semibold text-xs ">
                  ...
                  <Col className=" text-white" lg={5}>
                    ...
                    <div className="mt-4">
                      ...
                      <div className="border-b-2 border-gray-600 flex items-center p-2 justify-between">
                        ...
                        <p>
                          {" "}
                          {homePro.displacement} {homePro.gears}{" "}
                        </p>
                      </div>
                    </div>
                  </Col>
                ...
                <Row className="justify-center h-auto mt-5 text-white">
                  <div className=" flex ps-3 items-center">
                    <h3 className="font-bold text-start pt-2 pb-3">
                      Features & Options
                    </h3>
                  </div>
                  <Col className="border-white" lg={6}>
                    <p className="flex gap-3">
                      {" "}
                      <FaCheck size={20} className="text-yellow-400" />
                      Nulla consequat enim
                    </p>
                    <p className="flex gap-3">
                      {" "}
                      <FaCheck size={20} className="text-yellow-400" />
                ...
                <Row className="justify-center h-auto mt-5 text-white">
                  <Col lg={3} className="h-auto border-white pb-3">
                    <div>
                      ...
                      <p className="flex gap-3 text-gray-300">
                        {" "}
                        <FaCheckCircle size={20} className="text-yellow-400" />
                        Auxiliary heating
                      </p>
                      <p className="flex gap-3 text-gray-300">
                        {" "}
                      ...
                      <p className="flex gap-3 text-gray-300">
                        {" "}
                        <FaCheckCircle size={40} className="text-yellow-400" />
                ...
                <Row className="justify-center h-auto mt-5 text-white">
                  ...
                  <Col lg={4} className="">
                    <div className="">
                      ...
                      <p className="text-gray-400 pb-2">
                        ...
                        Mercedes-Benz dealer or service partner and includes
                        additional services.
                      </p>
                  ...
                  <Col lg={4} className="p-2">
                    <div className="mb-4 items-center mt-3">
                      <label
                        htmlFor="inp_5"
                        className="block text-sm font-medium pb-2 text-gray-400"
                      >
                        YOUR MESSAGE:
                      </label>
                      <textarea
                        className=" p-2 border rounded-sm text-black font-semibold text-md  focus:outline-none focus:ring focus:border-blue-300"
                        name=""
                        id="inp_5"
                        cols="30"
                        rows="10"
                    ...
                    <button className="text-white bg-blue-500 px-4 rounded-sm font-bold text-md py-2 hover:bg-yellow-400">
                      Submit
                    </button>
                  </Col>
                </Row>
            ...
            <Col className=" bg-black h-auto" lg={3}>
              ...
              <Row className="justify-center pt-2 bg-blue-500 text-white p-2 cursor-pointer hover:bg-blue-600">
                <Link to={"/singlePage/checkout"}>
                  <h6
                    onClick={onClickCart}
                    className="text-center text-gray-900 text-md hover:text-gray-700 font-semibold"
                  >
                    BUY CAR ONLINE
                  </h6>
                </Link>
                ...
                <Col
                  className="border-e h-20 flex  justify-center flex-col items-center"
                  lg={5}
                >
                ...
                <Col
                  className="border-s  h-20 flex flex-col justify-center items-center"
                  lg={5}
                >
                  <h6 className=" text-sm font-semibold">NEW PRICE</h6>
                  <h6>${homePro.msrp}</h6>
                </Col>
                <div className="bg-gray-700 h-8 flex  justify-center items-center mt-2">
                ...
                <Col className="">
                  ...
                  <Col>
                    <div className="flex gap-4 justify-center items-center border-b-2 pt-4 cursor-pointer">
                      <img
                        src="https://motors.stylemixthemes.com/classified/wp-content/uploads/sites/2/2016/12/ava1-160x160-160x160.jpg"
                        alt=""
              ...
              <Row className="justify-center pt-2 mt-3 text-white p-2 h-auto bg-gray-800">
                <Col className="">
                  ...
                  <div className="flex justify-around items-center  border-b-2">
                    ...
                    <p className="pt-3 font-semibold text-md">
                      {homePro.mileage}mi
                    </p>
                  </div>
                  <div className="flex justify-around items-center  border-b-2">
              ...
              <Row className="justify-center pt-2 mt-3 bg-gray-800 text-white p-2   h-auto pb-3">
                ...
                <div className="text-black font-bold mt-4 pb-3">
                  <label
                    ...
                    className="font-sm text-md flex text-white gap-2 pb-2"
                  >
                ...
                <button
                  className="font-bold text-lg hover:bg-blue-600 px-3 py-2 bg-blue-500"
